    ...
    <div class="flex flex-col justify-center m-3">
        ...
        <div id="datos-tabla" class="mx-8">
            ...
            >
                ...
                >
                    <a :href="'/crud/show-edit-ubication/' + props.row.id"
                        >Editar</a
                    >
                </button>
                <button
...
export default {
    ...
    methods: {
        ...
        listTypesAtractivos() {
            axios
              .get("/list-type-points", this.listTypes)
              .then((response) => {
        ...
        deleteMural(id) {
            axios.delete("/delete-type-point/" + id).then((response) => {
