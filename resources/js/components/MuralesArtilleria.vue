<template>
    <div class="justify-center">
        ...
        <h1 class="text-3xl text-center py-2">CERRO ARTILLERIA</h1>
...
export default {
    ...
    methods: {
        ...
        listMurales() {
            axios.get('/api-murales-artilleria') // Va a web.php por defecto y busca el nombre de la ruta que arroja el JSON
