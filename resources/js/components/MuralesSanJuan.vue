<template>
    <div class="justify-center">
        ...
        <h1 class="text-3xl text-center py-2">CERRO SAN JUAN DE DIOS</h1>
...
export default {
    ...
    methods: {
        ...
        listMurales() {
            axios.get('/api-murales-san-juan') // Va a web.php por defecto y busca el nombre de la ruta que arroja el JSON
