...
<h1 class="text-3xl text-center py-2">CERRO CORDILLERA</h1>
...
export default {
    ...
    methods: {
        ...
        listMurales() {
            axios.get('/api-murales-cordillera') // Va a web.php por defecto y busca el nombre de la ruta que arroja el JSON
