<template>
    <div class="justify-center">
        ...
        <h1 class="text-3xl text-center py-2">CERRO MARIPOSAS</h1>
...
export default {
    ...
    methods: {
        ...
        listMurales() {
            axios.get('/api-murales-mariposas') // Va a web.php por defecto y busca el nombre de la ruta que arroja el JSON
