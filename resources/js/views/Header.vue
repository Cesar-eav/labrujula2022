...
<nav class="px-2 bg-red-500 text-gray-200 shadow-lg ">
    ...
    <div class="hidden w-full md:block md:w-auto" id="mobile-menu">
      <ul class="Menu-Escritorio flex flex-col p-4  rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        ...
        <li>
            ...
            <!-- Dropdown menu -->
            <div id="dropdownNavbar" class="hidden z-10 w-44 font-normal bg-red-200 rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 487px);" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom">
